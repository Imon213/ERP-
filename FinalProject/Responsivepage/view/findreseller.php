...
require('../db.php');
$conn=getConnection();
$sql="select * from user where status='accepted'";
...
<head>
    ...
    <script type="text/javascript" src="../js/findreseller.js"></script>
...
<body>
   <div class="container">
    ...
    <tr>
        ...
        <td width="100px"><img src="../image/remove.png" > 
        <a id="remove" href="removereseller.php?email=<?=$row['email']?>">Remove</a></td>
