...
<head>
    ...
    <link rel="stylesheet" href="../Design/removeresellerreq.css">
    <script type="text/javascript" src="../js/removereseller.js"></script>
...
<body>
   <div class="container">
       ...
       <div class="right" align="center">
              ...
              <h3 class="title"> REMOVE RESELLER</h3>
              <table>
           ...
           <input type="button" value="REMOVE" id="updatebutton" onclick="resRemove()">
               <a class="cancel" href="findreseller.php" >CANCEL</a><br><br>
               <h3 id="result2"></h3>
              </div>
