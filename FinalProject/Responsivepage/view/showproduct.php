...
<head>
    ...
    <link rel="stylesheet" href="../Design/showproduct.css">
   ...
   <div class="container">
       ...
       <div class="right">
           ...
           <?php while($row=mysqli_fetch_array($result)){?>
            ...
            $img=$row['image'];
            $link='../product/'.$img; ?>
            <a href="productdetails.php?id=<?=$row['id']?>" class="showdetails">
               <div class="product">
                  
               <img src="<?php echo $link; ?>" id="img"><br><br>
               <span class="prt">Product Name: </span>
               <span class='name'><?php echo $row['name'];?></span><br><br>
               <span class="prt1">Product Code: </span>
               <span class='name'><?php echo $row['id'];?></span><br><br>
               <span class="prt2">Product Type: </span>
               <span class='name'><?php echo $row['type'];?></span><br><br>
               <span class="prt">Product Price: </span>
